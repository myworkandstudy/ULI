...
typedef struct USMC_Mode_st{
    ...
    BOOL Tr1T;			// Trailer 1 TRUE state (TRUE : +3/+5В; FALSE : 0В)
    BOOL Tr2T;			// Trailer 2 TRUE state (TRUE : +3/+5В; FALSE : 0В)
    BOOL RotTrT;		// Rotary Transducer TRUE state (TRUE : +3/+5В; FALSE : 0В)
    ...
    BOOL Butt1T;		// Button 1 TRUE state (TRUE : +3/+5В; FALSE : 0В)
    BOOL Butt2T;		// Button 2 TRUE state (TRUE : +3/+5В; FALSE : 0В)
